...
app.use(cors({
    origin: [
        ...
        'https://shoplane2025.click', // 允許主域名
        'https://3.140.169.76:3002', // EC2 本機
        'https://localhost:3000',     // 允許本地前端開發（可依實際情況調整）
        'https://localhost:3002',      // 允許本地直接訪問    
        'https://localhost:3302',                                 
    ],
    credentials: true
})); // 使用 CORS 中间件，允許多來源跨域請求
...
const db = require('./api/db'); // 引入自定义数据库操作模块
